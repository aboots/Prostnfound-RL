...
export WANDB_NOTES="CSPCa detection"

loss=mil_prop_bce_entropy_reg # needle_region_ce, 
# loss=needle_region_ce

# age, psa, approx_psa_density, family_history, pos

prompts=age,psa,psad,pos

export WANDB_RUN_GROUP=prostnfound_prompt_abl_${prompts}
export WANDB_TAGS="test-$center"
model_kw="prompts=[${prompts}]"
